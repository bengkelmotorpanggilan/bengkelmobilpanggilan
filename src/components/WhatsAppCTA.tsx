...
export default function WhatsAppCTA() {
  ...
  return (
    ...
    >
      ...
      {/* WhatsApp button */}
      <a
        href="https://wa.me/6285199558339?text=Halo%20BengkelMobilPanggilan,%20saya%20membutuhkan%20bantuan%20servis%20mobil%20panggilan"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Hubungi BengkelMobilPanggilan via WhatsApp"
        className="relative flex items-center justify-center w-14 h-14 rounded-full transition-all hover:scale-110"
        style={{
          background: 'linear-gradient(135deg, #A3BE8C, #4CAF50)',
        ...
        {pulse && (
          <>
            ...
            <span
              ...
              style={{ background: '#A3BE8C', animationDelay: '0.3s' }}
            />
          </>
        )}
